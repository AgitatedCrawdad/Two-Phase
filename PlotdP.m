function PlotdP(name,prop,prop2)
%%%%%%%%%%%%%%%%%%
...
%     
    error_a = std(get(a,prop)-get(a,prop2)); error_b = std(get(b,prop)-get(b,prop2));error_c = std(get(c,prop)-get(c,prop2));error_d = std(get(d,prop)-get(d,prop2));
    error_e = std(get(e,prop)-get(e,prop2));
    error_f = std(get(f,prop)-get(f,prop2)); error_g = std(get(g,prop)-get(g,prop2));error_h = std(get(h,prop)-get(h,prop2));
    error_i = std(get(i,prop)-get(i,prop2));
